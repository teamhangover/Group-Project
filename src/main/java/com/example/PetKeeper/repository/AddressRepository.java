...
public interface AddressRepository extends JpaRepository<Address, Integer> {
    ...
    //this native query finds addresses within 1km from the given lat/lng (center)
  @Query(value="SELECT * FROM addresses a HAVING ( 6371 * acos( cos( radians( ?1 ) ) * cos( radians( a.latitude ) ) * cos( radians( a.longitude ) - radians( ?2 ) ) + sin( radians( ?1 ) ) * sin( radians( a.latitude ) ) ) ) < 1;"
            , nativeQuery = true)
